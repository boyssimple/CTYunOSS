 ...
 */
typedef void(^OOSCancellationBlock)(void);

/*!
 The consumer view of a CancellationToken.
 Propagates notification that operations should be canceled.
 A OOSCancellationToken has methods to inspect whether the token has been cancelled.
 */
@interface OOSCancellationToken : NSObject
