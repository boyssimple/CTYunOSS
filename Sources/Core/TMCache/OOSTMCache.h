...
typedef void (^OOSTMCacheBlock)(OOSTMCache *cache);
typedef void (^OOSTMCacheObjectBlock)(OOSTMCache *cache, NSString *key, id object);

@interface OOSTMCache : NSObject
