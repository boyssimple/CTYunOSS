...
@class OOSTMMemoryCache;

typedef void (^OOSTMMemoryCacheBlock)(OOSTMMemoryCache *cache);
typedef void (^OOSTMMemoryCacheObjectBlock)(OOSTMMemoryCache *cache, NSString *key, id object);

@interface OOSTMMemoryCache : NSObject
 ...
 */
@property (copy) OOSTMMemoryCacheObjectBlock willAddObjectBlock;
 ...
 */
@property (copy) OOSTMMemoryCacheObjectBlock willRemoveObjectBlock;
 ...
 */
@property (copy) OOSTMMemoryCacheBlock didReceiveMemoryWarningBlock;
 ...
 */
@property (copy) OOSTMMemoryCacheBlock didEnterBackgroundBlock;
 ...
 */
- (void)trimToDate:(NSDate *)date block:(OOSTMMemoryCacheBlock)block;
