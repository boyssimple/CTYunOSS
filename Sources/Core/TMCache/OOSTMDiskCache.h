...
@class OOSTMDiskCache;
@protocol OOSTMCacheBackgroundTaskManager;

typedef void (^OOSTMDiskCacheBlock)(OOSTMDiskCache *cache);
typedef void (^OOSTMDiskCacheObjectBlock)(OOSTMDiskCache *cache, NSString *key, id <NSCoding> object, NSURL *fileURL);

@interface OOSTMDiskCache : NSObject
 ...
 */
@property (copy) OOSTMDiskCacheObjectBlock willAddObjectBlock;

/**
 A block to be executed just before an object is removed from the cache. The queue waits during execution.
 */
@property (copy) OOSTMDiskCacheObjectBlock willRemoveObjectBlock;
 ...
 */
- (void)trimToDate:(NSDate *)date block:(OOSTMDiskCacheBlock)block;
...
/**
 ...
 @param block A block to be executed serially after the cache has been trimmed, or nil.
 */
- (void)trimToSize:(NSUInteger)byteCount block:(OOSTMDiskCacheBlock)block;
...
/**
 ...
 @param block A block to be executed serially after the cache has been trimmed, or nil.
 */
- (void)trimToSizeByDate:(NSUInteger)byteCount block:(OOSTMDiskCacheBlock)block;
