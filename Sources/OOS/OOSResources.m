...
@interface OOSResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation OOSResources

+ (instancetype)sharedInstance {
    static OOSResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [OOSResources new];
    });
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        if (_definitionDictionary == nil) {
            if (error) {
                OOSDDLogError(@"Failed to parse JSON service definition");
            }
        }
    }
    return self;
...
- (NSString *)definitionString {
  ...
  \"operations\":{\
	\"CreateAccessKey\":{\
		...
		\"output\":{\"shape\":\"CreateAccessKeyOutput\"}\
	},\
	\"UpdateAccessKey\":{\
		...
		\"output\":{\"shape\":\"UpdateAccessKeyOutput\"}\
	},\
	\"DeleteAccessKey\":{\
		...
		\"output\":{\"shape\":\"DeleteAccessKeyOutput\"}\
	},\
	\"GetRegions\":{\
		\"name\":\"GetRegions\",\
		\"http\":{\
	...
	\"ListAccessKey\":{\
		...
		\"input\":{\"shape\":\"ListAccessKeyRequest\"},\
		\"output\":{\"shape\":\"ListAccessKeyOutput\"}\
	},\
    \"GetBucketTrigger\":{\
       \"name\":\"GetBucketTrigger\",\
		 \"http\":{\
           \"method\":\"GET\",\
           \"requestUri\":\"/{Bucket}?trigger\"\
        },\
        \"input\":{\"shape\":\"GetBucketTriggerRequest\"},\
        \"output\":{\"shape\":\"GetBucketTriggerOutput\"}\
    },\
	\"DeleteBucketTrigger\":{\
	  \"name\":\"DeleteBucketTrigger\",\
	  \"http\":{\
	     \"method\":\"DELETE\",\
			\"requestUri\":\"/{Bucket}/?trigger={TriggerName}\"\
		},\
	  \"input\":{\"shape\":\"DeleteBucketTriggerRequest\"}\
	},\
	\"PutBucketTrigger\":{\
	  \"name\":\"PutBucketTrigger\",\
	  \"http\":{\
	    \"method\":\"PUT\",\
	    \"requestUri\":\"/{Bucket}?trigger\"\
	  },\
	  \"input\":{\"shape\":\"PutBucketTriggerRequest\"}\
	},\
  ...
  \"shapes\":{\
    ...
    \"CreateBucketConfiguration\":{\
      ...
      \"members\":{\
        \"MetadataLocationConstraint\":{\
          \"shape\":\"MetadataLocationConstraint\"\
        },\
	...
	\"DataLocationConstraint\":{\
		...
		\"members\":{\
			...
			\"ScheduleStrategy\":{\
				\"shape\":\"ScheduleStrategy\"\
			}\
		}\
	},\
	\"LocationArray\":{\
		\"type\":\"list\",\
		\"member\":{\"shape\":\"DataLocation\"},\
		\"flattened\":true\
	},\
	\"LocationList\":{\
		\"type\":\"structure\",\
    ...
    \"HeadObjectOutput\":{\
      ...
      \"members\":{\
		...
		\"DataLocation\":{\
			\"shape\":\"DataLocationString\",\
			\"location\":\"header\",\
			\"locationName\":\"x-ctyun-data-location\"\
		},\
		\"MetadataLocation\":{\
			\"shape\":\"MetadataLocationString\",\
			\"location\":\"header\",\
			\"locationName\":\"x-ctyun-metadata-location\"\
		},\
      }\
    },\
	\"DataLocationString\":{\"type\":\"string\"},\
	\"MetadataLocationString\":{\"type\":\"string\"},\
    \"HeadObjectRequest\":{\
      \"type\":\"structure\",\
      \"required\":[\
        \"Bucket\",\
	...
	\"DataLocationHeader\":{\"type\":\"string\"},\
	\"MetaDataLocationHeader\":{\"type\":\"string\"},\
	...
	\"PutBucketTriggerRequest\":{\
		...
		\"members\":{\
			...
			\"TriggerConfiguration\":{\
				\"shape\":\"TriggerConfiguration\",\
				\"locationName\":\"TriggerConfiguration\",\
				\"xmlNamespace\":{\"uri\":\"http://s3.amazonaws.com/doc/2006-03-01/\"}\
			}\
		},\
		\"payload\":\"TriggerConfiguration\"\
	},\
	\"GetBucketTriggerOutput\":{\
		\"type\":\"structure\",\
		\"members\":{\
			\"TriggerConfiguration\":{\
				\"shape\":\"TriggerConfiguration\"\
	...
	\"DeleteBucketTriggerRequest\":{\
		\"type\":\"structure\",\
		\"required\":[\"Bucket\",\"TriggerName\"],\
		\"members\":{\
			\"Bucket\":{\
				\"shape\":\"BucketName\",\
				\"location\":\"uri\",\
			...
			\"TriggerName\":{\
				\"shape\":\"TriggerName\",\
				\"location\":\"uri\",\
				\"locationName\":\"TriggerName\"\
			}\
		}\
	},\
	\"GetBucketTriggerRequest\":{\
		\"type\":\"structure\",\
		\"required\":[\"Bucket\"],\
		\"members\":{\
			\"Bucket\":{\
	...
	\"RemontEndPoint\":{\"type\":\"string\"},\
	\"RemoteBucketName\":{\"type\":\"string\"},\
	\"ReplicaMode\":{\"type\":\"string\"},\
	\"RemoteAK\":{\"type\":\"string\"},\
	\"RemoteSK\":{\"type\":\"string\"},\
	\"Params\":{\"type\":\"string\"},\
	...
	\"RemoteSite\":{\
		...
		\"members\":{\
			\"RemontEndPoint\":{\"shape\":\"RemontEndPoint\"},\
			\"RemoteBucketName\":{\"shape\":\"RemoteBucketName\"},\
			\"ReplicaMode\":{\"shape\":\"ReplicaMode\"},\
			\"RemoteAK\":{\"shape\":\"RemoteAK\"},\
			\"RemoteSK\":{\"shape\":\"RemoteSK\"}\
		}\
	},\
	...
	\"ListAccessKeysResponse\":{\
		...
		\"members\":{\
			\"ResponseMetadata\":{\"shape\":\"ResponseMetadata\"},\
			\"ListAccessKeysResult\":{\"shape\":\"ListAccessKeysResult\"},\
		}\
	},\
	\"ListAccessKeysResult\":{\
		...
		\"members\":{\
			...
			\"Marker\":{\"shape\":\"Marker\"},\
			\"AccessKeyMetadata\":{\"shape\":\"AccessKeyMetadata\"},\
		}\
	},\
	\"AccessKeyMetadata\":{\
		\"type\":\"structure\",\
	...
	\"DeleteAccessKeyOutput\":{\
		...
		\"members\":{\
			\"DeleteAccessKeyResponse\":{\"shape\":\"DeleteAccessKeyResponse\"},\
		},\
		\"payload\":\"DeleteAccessKeyResponse\"\
	},\
	\"ListAccessKeyOutput\":{\
		\"type\":\"structure\",\
		\"required\":[\
		...
		\"members\":{\
			\"ListAccessKeysResponse\":{\"shape\":\"ListAccessKeysResponse\"},\
		},\
		\"payload\":\"ListAccessKeysResponse\"\
	},\
	\"UpdateAccessKeyOutput\":{\
		...
		\"members\":{\
			\"UpdateAccessKeyResponse\":{\"shape\":\"UpdateAccessKeyResponse\"},\
		},\
		\"payload\":\"UpdateAccessKeyResponse\"\
	},\
	\"DeleteAccessKeyResponse\":{\
		\"type\":\"structure\",\
		\"required\":[\
	...
	\"CreateAccessKeyOutput\":{\
		...
		\"members\":{\
			\"CreateAccessKeyResponse\":{\"shape\":\"CreateAccessKeyResponse\"},\
		},\
		\"payload\":\"CreateAccessKeyResponse\"\
	},\
	\"CreateAccessKeyResponse\":{\
		\"type\":\"structure\",\
		\"required\":[\
		...
		\"members\":{\
			\"CreateAccessKeyResult\":{\"shape\":\"CreateAccessKeyResult\"},\
			\"ResponseMetadata\":{\"shape\":\"ResponseMetadata\"},\
		}\
	},\
	\"ResponseMetadata\":{\
	...
	\"BucketRegions\":{\
		...
		\"members\":{\
			\"MetadataRegions\":{\"shape\":\"MetadataRegions\"},\
			\"DataRegions\":{\"shape\":\"DataRegions\"},\
		}\
	},\
	\"GetRegionsOutput\":{\
		\"type\":\"structure\",\
		...
		\"members\":{\
			\"BucketRegions\":{\"shape\":\"BucketRegions\"},\
		},\
		\"payload\":\"BucketRegions\"\
	},\
  }\
}";
}
